...
<!--
					<fieldset>
						...
						<div class="infldset" style="display:none">
							<input type="hidden" name="form_sent" value="1" />
...
//-->
				...
				<!--Prevent forum moderators from viewing user email addresses-->
				<?php if($pun_user['g_id'] != PUN_MOD || $id == $pun_user['id']):?>
				<!--Hide email field-->
				<!--<div class="inform">
					<fieldset>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							...
							<?php 
// Allow editing of signature if the user's group is not the same as the default new user group (New Scratcher), or the signature is not null (meaning they already got a signature from the old 15 day rule)
if ($pun_user['group_id'] != $pun_config['o_default_user_group'] || $pun_user['signature']):?>
							...
							<p><input type="submit" name="update" value="<?php echo $lang_common['Submit'] ?>" /><?php echo $lang_profile['Instructions'] ?></p>
							<?php else:?>
							<p><b><?php printf($lang_profile['Allow sig msg'],SHOW_SIGNATURE_AFTER_NDAYS)?></b></p>
