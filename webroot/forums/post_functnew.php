...
<a href="#req_message"><img src="img/sbcats/motion.png" onClick="LoadMotion()" alt="motion"></a>
<a href="#req_message"><img src="img/sbcats/looks.png" onClick="LoadLooks();" alt="looks"></a>
<a href="#req_message"><img src="img/sbcats/sound.png" onClick="LoadSound()" alt="sound"></a>
<a href="#req_message"><img src="img/sbcats/pen.png" onClick="LoadPen()" alt="pen"></a>
<a href="#req_message"><img src="img/sbcats/control.png" onClick="LoadControl()" alt="control"></a>
<a href="#req_message"><img src="img/sbcats/sensing.png" onClick="LoadSensing()" alt="sensing"></a>
<a href="#req_message"><img src="img/sbcats/numbers.png" onClick="LoadNumbers()" alt="numbers"></a>
<a href="#req_message"><img src="img/sbcats/variables.png" onClick="LoadVariables()" alt="variables"></a>

<br>
<div id="motion" style="overflow: auto; width: 400px; height: 100px;">
<br>
  <a href="#req_message"><img onload="divsdisappear()" border=0 name="move_steps" alt="move_steps" onclick="insertAtCursor(document.post.req_message, '<move(  )steps>');" /></a> 
