...
$smiley_text = array(':)', '=)', ':|', '=|', ':(', '=(', ':D', '=D', ':o', ':O', ';)', ':/', ':P', ':lol:', ':mad:', ':rolleyes:', ':cool:', '<move(' , ')steps>', '<turn cw(', '<turn ccw(', ')degrees>', '<point in direction(', '<point towards(', '<when green flag clicked>', '<if>', '<end>', '<reset timer>', ' <mouse x>', '<mouse down?>', '<<', '>>', '<and>');
$smiley_img = array('<img src="img/smilies/smile.png" alt="smile" />', '<img src="img/smilies/smile.png" alt="smile" />', '<img src="img/smilies/neutral.png" alt="neutral" />', '<img src="img/smilies/neutral.png" alt="neutral" />', '<img src="img/smilies/sad.png" alt="sad" />', '<img src="img/smilies/sad.png" alt="sad" />', '<img src="img/smilies/big_smile.png" alt="big_smile" />', '<img src="img/smilies/big_smile.png" alt="big_smile" />', '<img src="img/smilies/yikes.png" alt="yikes" />', '<img src="img/smilies/yikes.png" alt="yikes" />', '
<img src="img/smilies/wink.png" alt="wink" />', '<img src="img/smilies/hmm.png" alt="hmm" />', '<img src="img/smilies/tongue.png" alt="tongue" />', '<img src="img/smilies/lol.png" alt="lol" />', '<img src="img/smilies/mad.png" alt="mad" />', '<img src="img/smilies/roll.png" alt="roll" />', '<img src="img/smilies/cool.png" alt="cool" />', '</a> <img src="img/blocks/move.png" alt="move" class="stack" /> <a class="textstack">', '&nbsp;&nbsp;</a> <img src="img/blocks/steps.png" alt="steps" class="nbstack" /> <a class="textstack">', '</a> <img src="img/blocks/turncw.png" alt="turn clockwise" class="stack" /> <a class="textstack">', '</a> <img src="img/blocks/turnccw.png" alt="turn counterclockwise" class="stack" /> <a class="textstack">', '&nbsp;&nbsp;</a> <img src="img/blocks/degreesbot.png" alt="degrees" class="nbstack" /> <a class="textstack">', '</a> <img src="img/blocks/pointindirection_.png" alt="point in direction" class="stack" /> <a class="textstack">', '</a> <img src="img/blocks/pointtowards_.png" alt="point towards" class="stack" /> <a class="textstack">', '<img src="img/blocks/whengreenflagclicked.png" alt="greenflag" class="hat" /> <a class="textstack">', ' </a> <img src="http://paulmedwal.com/if_5.png" class="controlstack" /> <a class="textstack"> ', ' </a> <img src="http://paulmedwal.com/endcontrol2.png" class="controlstack" /> <a class="textstack"> ', '</a> <img src="img/blocks/resettimer.png" alt="reset timer" class="stack" /> <a class="textstack">', ' </a> <img src="http://paulmedwal.com/mousex_smb.png" class="numstack" /> <a class="textstack"> ', ' </a> <img src="http://paulmedwal.com/mousedownqsm.png" class="boolstack" />  <a class="textstack"> ', '</a> &nbsp;&nbsp;<img src="http://paulmedwal.com/leftghook.png" class="boolstack" /> <a class="textstack"> ', ' </a> <img src="http://paulmedwal.com/rightghook.png" class="boolstack" />&nbsp;&nbsp; <a class="textstack"> ', ' </a> <img src="http://paulmedwal.com/_and_7.png" class="boolstack" /> <a class="textstack"> ');
...
//			$text = preg_replace('#\[img\]((ht|f)tps?://)([^\s<"]*?)\.(jpg|jpeg|png|gif)\[/img\]#e', 'handle_img_tag(\'$1$3.$4\')', $text);
	...
	$pattern = array('[blocks]', '[/blocks]');
	$replace = array('<br />', ' </a> ');
	$text = str_replace($pattern, $replace, $text);

	//Deal with tag problems from Scratch blocks
	$pattern = array('<br /> </a>', '<br />&nbsp; </a>');
	$replace = array('</a> <br />', '</a> <br /> &nbsp;');
	$text = str_replace($pattern, $replace, $text);

	//Deal with tag problems from Scratch blocks
	$pattern = array('<a class="textstack"> </a>', '<a class="textstack">&nbsp; &nbsp; &nbsp;</a>', '<a class="textstack">&nbsp; </a>', '<a class="textstack">&nbsp; &nbsp;</a>', '<a class="textstack">&nbsp; &nbsp; &nbsp;&nbsp;</a>', '<a class="textstack">&nbsp; &nbsp; </a>');
	$replace = array('', '', '', '', '', '');
	$text = str_replace($pattern, $replace, $text);
