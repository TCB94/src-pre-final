...
$smiley_text = array('<move(' , ')steps>', '<turn cw(', '<turn ccw(', ')degrees>', '<point in direction(', '<point towards(', '<go to x:(', ')y:(', '<go to[', '<glide(', ')secs to x:(', '<change x by(', '<set x to(', '<change y by(', '<set y to(', '<if on edge, bounce>', '<when green flag clicked>', '<if>', '<end>', '<reset timer>', ' <mouse x>', '<mouse down?>', '<<', '>>', '<and>', ':)', '=)', ':|', '=|', ':(', '=(', ':D', '=D', ':o', ':O', ';)', ':/', ':P', ':lol:', ':mad:', ':rolleyes:', ':cool:');
$smiley_img = array(
