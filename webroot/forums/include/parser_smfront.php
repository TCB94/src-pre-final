...
$smiley_text = array(':)', '=)', ':|', '=|', ':(', '=(', ':D', '=D', ':o', ':O', ';)', ':/', ':P', ':lol:', ':mad:', ':rolleyes:', ':cool:', '<move(' , ')steps>', '<turn cw(', '<turn ccw(', ')degrees>', '<point in direction(', '<point towards(', '<go to x:(', ')y:', '<go to [', '<glide(', ')secs to x:(', '<change x by(', '<set x to(', '<change y by(', '<set y to(', '<if on edge, bounce>', '<when green flag clicked>', '<if>', '<end>', '<reset timer>', ' <mouse x>', '<mouse down?>', '<<', '>>', '<and>');
...
, '</a> <img src="img/blocks/if_5.png" class="controlstack" /> <a class="textstack">'
, '</a> <img src="img/blocks/endcontrol2.png" class="controlstack" /> <a class="textstack">'
, '</a> <img src="img/blocks/resettimer.png" alt="reset timer" class="stack" /> <a class="textstack">'
, '</a> <img src="img/blocks/mousex_smb.png" class="numstack" /> <a class="textstack">'
, '</a> <img src="img/blocks/mousedownqsm.png" class="boolstack" />  <a class="textstack">'
, '</a> &nbsp;&nbsp;<img src="img/blocks/leftghook.png" class="boolstack" /> <a class="textstack">'
, '</a> <img src="img/blocks/rightghook.png" class="boolstack" />&nbsp;&nbsp; <a class="textstack">'
, '</a> <img src="img/blocks/_and_7.png" class="boolstack" /> <a class="textstack">'
