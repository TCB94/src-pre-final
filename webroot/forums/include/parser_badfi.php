...
, '</a> <img src="img/blocks/forever.png" alt="forever" class="controlstack" /> <a class="textstack">'
, '</a> <img src="img/blocks/repeat_.png" alt="repeat" class="controlstack" /> <a class="textstack">'
