...
// Language definitions used in the mod "Move Post" 1.3

$lang_movepost = array(

'Mod move post'			=>	'[Move Post 1.3] - Move a post',
...
'Explain move post plain'			=>	'Enter the destination topic ID',
'Explain move post radio'			=>	'Or click on the destination topic',
