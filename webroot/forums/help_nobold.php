...
<div class="box">
	<div style="padding-left: 4px">
		<a name="blocks"></a>To add Scratch Blocks to your forum post type [blocks] before the blocks that you want to add and [/blocks] after. In between [blocks] and [/blocks] type in the name of the block you want to add as listed below.<br /><br />
