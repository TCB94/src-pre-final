<?php
 class AdministrationController extends AppController {
   ...
   function beforeFilter() {
		...
		//$allowed =array('ban_user','add_banned_user','render_banned_users','remove_banned_user','set_banned_users','ban_ip','expand_ip','render_ips','add_ban_ip','remove_ban_ip','index', 'integraflag', 'set_announcements', 'update_announcements', 'set_announcement_visibility');
