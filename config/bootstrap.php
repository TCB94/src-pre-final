 ...
 */
 ...
 define("NUM_MAX_PROJECT_FLAGS", 0);
 ...
 */
 define("REPLY_TO_FLAGGED_PCOMMENT", "jacob@futuresight.org");
 define("TO_FLAGGED_PCOMMENT", "jacob@futuresight.org");
 define("REPLY_TO_FLAGGED_PROJECT", "jacob@futuresight.org");
 define("TO_FLAGGED_PROJECT", "jacob@futuresight.org");
 define("FROM_FLAGGED_PROJECT", "jacob@futuresight.org");
 define("REPLY_TO_FLAGGED_GCOMMENT", "jacob@futuresight.org");
 define("TO_FLAGGED_GCOMMENT", "jacob@futuresight.org");
 define("REPLY_TO_FLAGGED_PTAG", "jacob@futuresight.org");
 define("TO_FLAGGED_PTAG", "jacob@futuresight.org");
 define("REPLY_TO_FLAGGED_GTAG", "jacob@futuresight.org");
 define("TO_FLAGGED_GTAG", "jacob@futuresight.org");
 //Emais id to send mail to request create multiple account using same ip.
 define("TO_REQUEST_FOR_MULTIPLE_ACCOUNT", "jacob@futuresight.org");
 ...
 define("DEFAULT_EMAIL_FROM", "jacob@futuresight.org");
 //Used in componenets/email 
 define("DEFAULT_EMAIL_TO", "jacob@futuresight.org");
 define("CONTACTUS_EMAIL", "jacob@futuresight.org");
 define("APPEALS_CONTACT_EMAIL", "jacob@futuresight.org");
 //Used in  users password recovery reply email id.
 define("REPLY_TO_PASSWORD_RECOVERY", "jacob@futuresight.org");
 ...
 */
 ...
 define("NUM_RAMIXED_TAGED_PROJECT", 10); // 
 ...
 define("TAGED_TOPVIEWED_PROJECT_CACHE_TTL", 360); 
  define("LATEST_TOPVIEWED_DAY_INTERVAL", 5);
 define("NUM_TOPLOVED_TAGED_PROJECT", 2); // 
 ...
 */
define("TOPIC1", "jacob@futuresight.org");
define("TOPIC2", "jacob@futuresight.org");
define("TOPIC3", "jacob@futuresight.org");
define("TOPIC4", "jacob@futuresight.org");
define("TOPIC5", "jacob@futuresight.org");
define("TOPIC6", "jacob@futuresight.org");
define("TOPIC7", "jacob@futuresight.org");
define("TOPIC8", "jacob@futuresight.org");

define("SUBTOPIC1", "jacob@futuresight.org");
define("SUBTOPIC2", "jacob@futuresight.org");
define("SUBTOPIC3", "jacob@futuresight.org");
...
* Define Java path
**/
define('JAVA_PATH', '/usr/lib/jvm/default-java/jre/bin/java');
...
function isInappropriate($content) {
    ...
    $blacklist = array("n1gr","nigga","nigger","nigur","niiger","niigr");
// you cant say the nword haha loser
    ...
    //full word check
    return preg_match("/(^|\b)(sussy|sus|baka)((s|z)?)(\b|$)/", $content);
}
